...
export default function Terms() {
    ...
    return (
        <Layout>
            ...
            <p>
                Full payment must be received before booking is secured
                If booking is cancelled within 14 day of booked dates no refund will be given
                A cancellation charge of £10 will be payable ( will be deducted before any refund is given )
            </p>
            ...
            <p>
                These standard conditions apply to all hiring of Cavendish Park Community Hub. If the Hirer is in any doubt as to the meaning of the following, the Hall Booking secretary should immediately be consulted.
            </p>
            ...
            <p>
                The Hirer shall not use the premises for any purpose other than that described in the Hiring Agreement and shall not sub-hire or use the premises or allow the premises to be used for any unlawful purpose or in any unlawful way nor do anything or bring onto the premises anything which may endanger the same or render invalid any insurance policies in respect thereof. Barrow Island Community Sports Trust reserve the right to enter or inspect the hall at any time deemed fit by a member of the management committee.
            </p>
            ...
            <p>
                If licences are required in respect of any activity in Cavendish Park Community Hub it is the responsibility of the Hirer to ensure that they hold or obtain the necessary licence for the activity.
            </p>
            ...
            <p>
                ...
                <ol>
                    ...
                    <li>
                        In advance of an entertainment or play <strong>the Hirer shall check the following items:</strong>
                    </li>
                </ol>
            </p>
            <p>
            ...
            <p>
                The Hirer must report all accidents involving injury to the public to the Booking secretary as soon as possible and complete the relevant section in Cavendish Park Community Hub accident book. Any failure of equipment belonging to Cavendish  Park Community Hub  or brought in by the Hirer must also be reported as soon as possible. Certain types of accident or injury must be reported on a special form to the local authority. The Hall Management Committee will give assistance in completing this form. This is in accordance with the Reporting of Injuries, Diseases and Dangerous Occurrences Regulations 1995 (RIDDOR). http://www.hse.gov.uk/riddor/report.htm#online
            </p>
            ...
            <p>
                The Hirer shall indemnify and keep indemnified each member of Barrow Island Community Sports Trust Management Committee and Cavendish Park Community Hub employees, volunteers, agents and invitees against
            ...
            <p>
                The Hirer shall not carry out or permit fly posting or any other form of unauthorised advertisements for any event taking place at the premises, and shall indemnify and keep indemnified each member of the Barrow Island Community Sports Trust management committee accordingly against all actions, claims and proceedings arising from any breach of this condition. Failure to observe this condition may lead to prosecution by the local authority.
            </p>
            ...
            <p>
                If the Hirer wishes to cancel the booking before the date of the event and Barrow Island Community Sports Trust is unable to conclude a replacement booking, the question of the payment or the repayment of the fee shall be at the discretion of The Management Committee.
                Barrow Island Community Sports Trust reserves the right to cancel this hiring by written notice to the Hirer in the event of:
                The premises being required for use as a Polling Station for a Parliamentary or Local Government election or by-election
                Barrow Island Community Sports Trust Management Committee reasonably considering that
                <ol>
                    <li>
            ...
            <p>
                ...
                In any such case the Hirer shall be entitled to a refund of any deposit already paid, but Barrow Island Community Sports Trust shall not be liable to the Hirer for any resulting direct or indirect loss or damages whatsoever.
            </p>
            <h3>
                Stored Equipment
            </h3>
            <p>
                Barrow Island Community Sports Trust accepts no responsibility for any stored equipment or other property brought on to or left at the premises, and all liability for loss or damage is hereby excluded.
            </p>
            ...
            <h3>
                Compliance with The Children Act 1989/2004
            </h3>
            <p>
                The Hirer shall ensure that any activities for children under eight years of age comply with the provisions of The Children Act of 1989/2004 and that only fit and proper persons who have passed the appropriate Criminal Records Bureau checks have access to the children (checks may also apply where children over eight and vulnerable adults are taking part in activities). The Hirer shall provide the Barrow Island Community Sports Trust with a copy of their Child Protection Policy on request.
            </p>
            ...
            <p>
                The Hirer shall ensure that no animals (including birds) except guide dogs are brought into the premises, other than for a special event agreed to by The Barrow Island Community Sports Trust Management Committee No animals whatsoever are to enter the kitchen at any time.
            </p>
            ...
            <p>
                No alterations or additions may be made to the premises nor may any fixtures be installed or placards, decorations or other articles be attached in any way to any part of the premises without the prior written approval of the Booking secretary or Hall Management Committee. Any alteration, fixture or fitting or attachment so approved shall at the discretion of Barrow Island Community Sports Trust committee remain in the premises at the end of the hiring. It will become the property of Cav Park Community Hall unless removed by the hirer who must make good to the satisfaction of the hall or, if any damage caused to the premises by such removal.
            </p>
            ...
            <p>
                The Hirer shall be responsible for leaving the premises and surrounding area in a clean and tidy condition, properly locked and secured unless directed otherwise and any contents temporarily removed from their usual positions properly replaced, otherwise Barrow Island Community Sports Trust shall be at liberty to make an additional charge.
            </p>
