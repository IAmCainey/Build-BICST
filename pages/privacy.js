...
export default function Privacy() {
  ...
  const description =
    "Barrow Island Community Sports Trust, please make sure you read and understand the privacy policy setout by the trust.";
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Barrow Island Community Sports Trust,
            Craven Park, Barrow Island.
          </p>
        </li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Barrow Island Community Sports
            Trust, accessible from{" "}
            <a href="https://bicst.co.uk">https://bicst.co.uk</a>
          </p>
          ;
        </li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a href="https://bicst.co.uk/contact">
              https://bicst.co.uk/contact
            </a>
          </p>
        </li>
