      ...
      <footer className={style.footer}>
        <div className={style.container}>
          ...
          <div className={style.item}>
            ...
            <p className={style.text}>
              Please feel free to contat Barrow Island Community Sports Trust
              with any questions you have.
            </p>
            <p className={style.text}>
              Barrow Island Community Sports Trust ltd. <br />
              Cavendish Park, Barrow Island, Cumbria. <br />
              Contact Number : <span className={style.span}>
                01229 820470
              </span>{" "}
              <br />
              <a className={style.link_2} href="mailto:bicstrust@gmail.com">
                bicstrust@gmail.com
              </a>
            </p>
            <Image
        ...
        <div className={style.footer_note}>
          <p className={style.text}>
            developed by //{" "}
            <a
              className={style.link_2}
              href="https://paulcaine.co.uk"
              target="blank"
            >
              Paul Caine
            </a>
